...
<Link href='/adddata/add'>
  ...
  {Object.keys(data).map((id) => (
    <tr className="text-center" key={id}>
      <td className="py-2 px-4 border-b">{data[id].PersonalDetails.Name}</td>
      <td className="py-2 px-4 border-b">{data[id].Email}</td>
      <td className="py-2 px-4 border-b">{data[id].Contact}</td>
      <td className="py-2 px-4 border-b">{data[id].JobDescription.Department}</td>
      <td className="py-2 px-4 border-b">{data[id].PersonalDetails.Gender}</td>
      <td className="py-2 px-4 border-b">{data[id].PersonalDetails.Age}</td>
      <td className="py-2 px-4 border-b">{data[id].JobDescription.HireDate}</td>
